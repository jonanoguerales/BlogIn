...
const Register = () => {
	...
	const expresiones = {
		username: /^[A-Z][a-zA-Z0-9_-]{4,16}$/, // Letras, numeros, guion y guion_bajo y que empiece por mayuscula
	...
	<main>
		...
		<Formulario action="" onSubmit={onSubmit}>
			<Input
				...
				placeholder="john123"
				name="usuario"
				leyendaError="El usuario tiene que empezar por mayucula, ser de 4 a 16 dígitos y solo puede contener numeros, letras y guion bajo."
